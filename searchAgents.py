        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if self.walls[nextx][nexty] == False:
                ...
                for corner in self.corners:
                    ...
                    if (state[1][c] or (nextx, nexty) == corner):
                        cornersBool[c] = True

                    c = c + 1

                successors.append((((nextx, nexty), tuple(cornersBool)), action, 1))
...
def cornersHeuristic(state, problem):
    ...
    if not state[1][0]:
        h = util.manhattanDistance((x, y), (1, 1))
    elif not state[1][1]:
        h = util.manhattanDistance((x, y), (1, top))
    elif not state[1][2]:
        h = util.manhattanDistance((x, y), (right, 1))
    elif not state[1][3]:
        h = util.manhattanDistance((x, y), (right, top))
